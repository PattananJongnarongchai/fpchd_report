    ...
    <div class="container-fluid">
      <div class="card-body ">
        <div class="container">
          <div class="d-flex">
            <!-- Date Filter Section -->
            <div class="px-4 col-md-6 col-md-12">
              <form action="" method="post" id="dateFilterForm">
                <div class="row">
                  <label class="col-md-auto col-sm-12 mt-2"><b>เริ่มต้น</b></label>
                  <div class="col-md-auto col-sm-12 mb-2">
                    <input type="date" id="start_date" name="start_date" data-date-format="dd-mm-Y" class="form-control" value="<?= isset($_POST['start_date']) ? $_POST['start_date'] : ''; ?>">
                  </div>
                  <label class="col-md-auto col-sm-12 mt-2"><b>ถึง</b></label>
                  <div class="col-md-auto col-sm-12 mb-2">
                    <input type="date" id="end_date" name="end_date" data-date-format="dd-mm-Y" value="<?= $date; ?>" class="form-control">
                  </div>
                  <div class="col-sm-4">
                    <div class="row">
                      ...
                      <div class="col-md-auto col-sm-6">
                        <button type="button" onclick="generateReport()" class="btn btn-secondary w-100">
                          <div><i class="fa-solid fa-file-pdf"></i> สรุปเอกสารร้องเรียน</div>
                        </button>
                      </div>
                    </div>
                  </div>
      ...
      <div class="container">
        <div class="row pt-3" style="padding-left: 15px;">
          <div class="col-6 col-sm-3">
            <div class="card   mb-3 shadow shadow-intensity-xl" style="max-width: 18rem; background-color: #6ddb6b;">
          ...
          <div class="col-6 col-sm-3">
            <div class="card  mb-3 shadow shadow-intensity-xl" style="max-width: 18rem; background-color: #d0db6b;">
              <div class="card-header">
          ...
          <div class="col-6 col-sm-3">
            <div class="card mb-3 shadow shadow-intensity-xl" style="max-width: 18rem; background-color:#6bdbd9 ;">
              <div class="card-header">
          ...
          <div class="col-6 col-sm-3">
            <div class="card  mb-3 shadow shadow-intensity-xl" style="max-width: 18rem; background-color:#d98175;">
              <div class="card-header">
          ...
          <div class="container" style="overflow-x:auto;">
            <div class="card-body">
              <span class="d-flex justify-content-between">
                <b class="display-6 ">รายการเอกสารร้องเรียน</b>
                <button type="button" class="btn btn-sm btn-primary shadow shadow-intensity-xl" data-bs-toggle="modal" data-bs-target="#insert_data">
            ...
            <table id="myTable" class="table table-hover shadow shadow-intensity-xl" style="width:100%; text-align:30px;">
              ...
              <tbody>
                ...
                foreach ($result as $k) {
                  ...
                  if ($k['dc_results'] == 'รับข้อร้องเรียน') {
                ?>
                    <script>
                    ...
                    <tr>
                      ...
                      <td style="vertical-align: middle; width: 200px;"><?= $k['receiving_dc']; ?></td>
                      ...
                      <script>
                        function openPdfViewer(id_dc) {
                          ...
                          var pdfViewerUrl = 'เอกสารร้องเรียน?id_dc=' + id_dc;
                          // เปิดในแท็บใหม่
                      ...
                      <script>
                        function generateReport() {
                          ...
                          // สร้าง URL สำหรับส่งข้อมูลไปยังหน้า PHP ที่ใช้ mPDF เพื่อสร้างรายงาน
                          var url = 'สรุปเอกสารการ้องเรียน?start_date=' + startDate + '&end_date=' + endDate;

                          // เปิดหน้าใหม่เพื่อดาวน์โหลดรายงานใหม่
...
<?php
if (isset($_SESSION['cm_acpt']) && $_SESSION['cm_acpt'] == 01) {
  $_SESSION['success'] = "รับข้อร้องเรียนแล้ว!!";
  echo "<script>
    $(document).ready(function() {
        Swal.fire({
            title: 'สำเร็จ',
            text: 'รับข้อร้องเรียนแล้ว!!',
            icon: 'success',
            timer: 1500,
