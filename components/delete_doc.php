<!-- Modal ลบข้อมูล -->
<div class="modal fade" id="deldocModal<?= $k['id_dr']; ?>" tabindex="-1" aria-labelledby="del_data<?= $k['id_dr']; ?>" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                ...
                <div class="mt-2 modal-footer">
                    <a href="./CRUD/del_doc.php?id=<?= $k['id_dr']; ?>" type="button" class="btn btn-danger">ยืนยัน</a>
